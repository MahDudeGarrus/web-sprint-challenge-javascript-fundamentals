...
// making a comment to test if codegrade detects a change in the sprint test//
...
const zooAnimals = [
  ...
  */
  ...
  function consume(a, b, cb){   //HOF will receive the callbacks as arguements
    return cb(a, b);
  }
...
function add(a, b){   // callback for consume()
    return a + b;
  }

// 🦁🦁🦁 Use multiply to return the product of two numbers 🦁🦁🦁
  
function multiply(a, b){  // callback for consume()
   return a * b;
  }
...
//     surfaceArea() {
//       return ((this.length * this.height * this.width) * 2);
//     }
//   }
